...
BDFACE_WORKSPACE="${BDFACE_WORKSPACE_DIR}/FaceLibraryDemo"
...
{
    echo 3 ------- copy assets -------
    sdkassetpath=$workpath"/tools/assets_all/"
    cp -r $sdkassetpath  $outputsdkassetpath
    ...
    cp -r $facelibrarysopath $outputsdklibspath
    rm -r $outputsdklibspath"/armeabi/"
    rm -r $outputsdklibspath"/arm64-v8a/"
    rm -r $outputsdklibspath"/x86/"
    
    echo ====after copy==
    ls $outputsdklibspath"/armeabi-v7a/"

    cp -r $facelibraryjarspath $outputsdklibspath
    ...
    cp -r $demoapppath $outputsdkdemopath"/app/"
    rm $outputsdkdemopath/app/src/main/assets/*
    echo $demoapppath
    echo $outputsdkdemopath"/app/"
    ...
    cp -r $outputsdklibspath  $outputsdkdemopath"/app/libs"
...
function BDFaceRunDemo()
{
    ...
    rm -r $outputsdkdemopath"/app/src/main/assets_bak/"
